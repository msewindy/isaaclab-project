...
def draw_shape(shape, color, size):
    ...
    if shape == "circle":
        ...
        shape_draw.ellipse(bbox, fill=color, outline="black", width = outline_width)

    elif shape == "semicircle":
        radius = size // 2
        bbox = [cx - radius, cy - radius, cx + radius, cy + radius]
        shape_draw.pieslice(bbox, start=0, end=180, fill=color, outline="black", width = outline_width)
        ...
        shape_draw.polygon(points, fill=color, outline="black", width = outline_width)

    elif shape == "square":
        half_size = size // 2
        bbox = [cx - half_size, cy - half_size, cx + half_size, cy + half_size]
        shape_draw.rectangle(bbox, fill=color, outline="black", width = outline_width)
...
def draw_regular_polygon(draw, cx, cy, radius, sides, color):
    ...
    draw.polygon(points, fill=color, outline="black", width = outline_width)
